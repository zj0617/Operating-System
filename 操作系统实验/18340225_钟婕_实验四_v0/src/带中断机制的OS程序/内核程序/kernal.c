...
void help()
{
	...
	printf("INT-run the interrupt program.\n\r");
	printf("dir-display the table of UPInfo.\n\r");
	printf("ls-dispaly the tree of files.\n\r");
	printf("batch-run a series of commands.\n\r");
